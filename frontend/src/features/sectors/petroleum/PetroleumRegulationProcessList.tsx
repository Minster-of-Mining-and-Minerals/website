            ...
            cell: ({ row }) => {
                ...
                return (
                    <div className="flex items-center gap-1">
                        <ComponentGuard anyPermissions={["PETROLEUM_REGULATION_PROCESSES:UPDATE"]}>
                            <Button
                                variant="ghost"
                                size="icon"
                        ...
                        <ComponentGuard anyPermissions={["PETROLEUM_REGULATION_PROCESSES:DELETE"]}>
                            <Button
                                variant="ghost"
                                size="icon"
                                title="Delete"
    ...
    const actions: ActionButton[] = [
        {
            ...
            permissions: ["PETROLEUM_REGULATION_PROCESSES:CREATE"],
        },
    ];
