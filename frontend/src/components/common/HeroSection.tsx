...
export default function HeroSection() {
    ...
    return (
        <div className="relative w-full h-[80vh] overflow-hidden" dir="rtl">
            {slides.map((slide, index) => (
                ...
                >
                    <div className={clsx("relative flex items-center justify-center w-full h-full overflow-hidden", slide.bg)}>
                        <Image
                            src={slide.image}
                            alt={slide.title}
                            fill
                        ...
                        {/* Content */}
                        <div className="relative w-full z-10 h-full flex items-center justify-center">
                            <div className="max-w-7xl  w-full px-6 text-left">
