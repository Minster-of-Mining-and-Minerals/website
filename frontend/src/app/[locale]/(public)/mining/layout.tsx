...
const items = [
    ...
    { label: "Resources", slug: "/mining/resource", description: "Overview of Ethiopia's mining sector" },
];
                    ...
                    <div className="pt-5 pb-10 w-full bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden space-y-6 px-7">
                        ...
                        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-7xl z-[999]">
                            <div className="pt-5 pb-10 w-full bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden space-y-6 px-7">
                                ...
                                <div className="bg-white flex items-center justify-center gap-4 overflow-x-auto whitespace-nowrap px-2 hide-scrollbar">
                                    {items.map((item) => {
