...
const ResourcePage = () => {
    ...
    // Helper to get file URL (images use optimized variants when available)
    ...
    return (
        <div className='min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 md:p-6'>
            ...
            <div className='max-w-7xl mx-auto mb-6'>
                <h1 className='text-2xl md:text-3xl font-bold text-gray-900 mb-2'>Mining Resources Library</h1>
                <p className='text-gray-600 text-sm md:text-base'>Access all necessary documents, forms, and guidelines for the mining sector</p>
            </div>
